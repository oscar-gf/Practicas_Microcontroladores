...
![Fig. 1](/Practica_1/Instrucciones/kicad0.png)
...
24. Now, it is time to assemble the schematic design needed to make the PCB of this manual, as shown in this
    [file](/Practica_1/Instrucciones/Minimum_card_system.pdf). Table I indicates in which library is included each component.
    
    ![Table1.1](/Practica_1/Instrucciones/table1.1.png)
    ![Table1.2](/Practica_1/Instrucciones/table1.2.png)
